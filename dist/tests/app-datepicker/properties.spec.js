...
describe('properties', () => {
    ...
    it(`takes snapshot (properties)`, async () => {
        ...
        await browser.saveScreenshot(`./src/tests/snapshots/${DATEPICKER_NAME}/properties-0-${browserName}.png`);
        await browser.executeAsync(async (a, done) => {
            const el = document.body.querySelector(a);
            el.min = '2020-01-15';
            el.value = '2020-01-17';
        ...
        await browser.saveScreenshot(`./src/tests/snapshots/${DATEPICKER_NAME}/properties-1-${browserName}.png`);
    });
    it(`renders with defined 'min'`, async () => {
        const [prop, attr, disabledDateContent, focusedDateContent,] = await browser.executeAsync(async (a, b, c, done) => {
        ...
        }, DATEPICKER_NAME, '.day--disabled', toSelector('.day--focused'));
    ...
    it(`renders with defined 'locale'`, async () => {
        const [prop, focusedDateContent, weekdayLabelsContents,] = await browser.executeAsync(async (a, b, c, done) => {
            const n = document.body.querySelector(a);
            const root = n.shadowRoot;
            n.min = '2000-01-01';
            n.value = '2020-01-15';
    ...
    it(`renders with defined 'disabledDays'`, async () => {
        const [prop, disabledDatesContents,] = await browser.executeAsync(async (a, b, done) => {
            const n = document.body.querySelector(a);
            n.min = '2000-01-01';
            n.value = '2020-01-15';
            n.disabledDays = '1,5';
    ...
    it(`renders with defined 'disabledDates'`, async () => {
        ...
        const [prop, disabledDatesContents,] = await browser.executeAsync(async (a, b, c, done) => {
            const n = document.body.querySelector(a);
            n.min = '2000-01-01';
            n.value = '2020-01-15';
            n.disabledDates = b;
            await n.updateComplete;
            const disabledDates = Array.from(n.shadowRoot.querySelectorAll(c), o => o.outerHTML);
            done([
                n.disabledDates,
                disabledDates,
            ]);
    ...
    it(`renders with defined 'inline'`, async () => {
        const [prop, noDatepickerHeader,] = await browser.executeAsync(async (a, b, done) => {
            const n = document.body.querySelector(a);
            n.inline = true;
            await n.updateComplete;
    ...
    it(`renders with defined 'weekLabel'`, async () => {
        const [prop, weekNumberLabelContent,] = await browser.executeAsync(async (a, b, done) => {
            const n = document.body.querySelector(a);
            n.min = '2000-01-01';
            n.value = '2020-01-15';
            n.showWeekNumber = true;
    ...
    it(`renders with different 'showWeekNumber', 'firstDayOfWeek', and 'disabledDays'`, async () => {
        ...
        for (const showWeekNumber of [true, false]) {
            const [prop, attr, prop2, prop3, focusedDateContent, disabledDatesContent,] = await browser.executeAsync(async (a, b, c, d, done) => {
                const n = document.body.querySelector(a);
                const root = n.shadowRoot;
                n.min = '2000-01-01';
                n.value = '2020-01-15';
